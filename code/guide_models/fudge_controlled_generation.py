...
DATA_PATH = Path(
    r"D:\MS.c\MS.c\Yehudit\Clickbait_Detection_Project\ClickbaitTacticsDetection\Dataset_generation\combined_news_test.csv")
...
print(df.index[:100])
print(df.iloc[4]["title"])
for idx, row in df.iloc[[4, 23, 27, 28, 38]].iterrows():  # 4,23,27,28,38,66,71,86,79
...
results_df.to_csv(
    "prefix_generation_results_new_9.csv",
    index=False,
    encoding="utf-8-sig"
)

print("\nSaved results to prefix_generation_results_9.csv")
