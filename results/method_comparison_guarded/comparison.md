...
|---|---|---|---|---|---|---|---|
| dexperts | a0.5_b0.0 | 900 | 0.263 | 0.624 | 0.064 | 0.156 | 0.520 |
| dexperts | a1.0_b0.0 | 900 | 0.219 | 0.578 | 0.131 | 0.203 | 0.500 |
| dexperts | a2.0_b0.0 | 900 | 0.102 | 0.481 | 0.509 | 0.231 | 0.465 |
| dexperts | a4.0_b0.0 | 900 | -0.002 | 0.401 | 0.733 | 0.225 | 0.500 |
...
- fudge(a4.0_b2.0) vs dexperts(a4.0_b0.0) [bertscore_f1]: p=0.0, n=900, delta=0.2529
- fudge(a4.0_b2.0) vs dexperts(a4.0_b0.0) [sts]: p=0.0, n=900, delta=0.2321
- fudge(a4.0_b2.0) vs dexperts(a4.0_b0.0) [clickbait_prob_external]: p=0.0, n=900, delta=-0.676
- fudge(a4.0_b2.0) vs dexperts(a4.0_b0.0) [attr_realised_frac_guide_circular]: p=0.0, n=900, delta=-0.1511
- fudge(a4.0_b2.0) vs dexperts(a4.0_b0.0) [judge_attr_confirmed_frac]: p=0.4418, n=100, delta=0.035
